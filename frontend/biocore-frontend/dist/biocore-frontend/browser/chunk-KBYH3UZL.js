...
var PatientListComponent = class _PatientListComponent {
  constructor(patientService, notification) {
  ...
  loadAll() {
    ...
    this.patientService.getAll().subscribe({
      ...
      error: (err) => {
        this.notification.error("Error al cargar pacientes. Verifique que el backend est\xE9 corriendo.");
        this.loading = false;
      }
    });
  }
  static {
    this.\u0275fac = function PatientListComponent_Factory(t) {
      return new (t || _PatientListComponent)(\u0275\u0275directiveInject(PatientService), \u0275\u0275directiveInject(NotificationService));
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PatientListComponent, { className: "PatientListComponent", filePath: "src\\app\\modules\\patient\\patient-list\\patient-list.component.ts", lineNumber: 105 });
})();
export {
  PatientListComponent
};
//# sourceMappingURL=chunk-KBYH3UZL.js.map
