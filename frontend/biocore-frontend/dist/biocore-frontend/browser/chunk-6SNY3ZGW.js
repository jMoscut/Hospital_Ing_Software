...
var LabExamService = class _LabExamService {
  constructor(http) {
    this.http = http;
    this.url = `${environment.apiUrl}/lab-exams`;
  }
  getAll() {
  ...
  getByCategory(category) {
    return this.http.get(`${this.url}/category/${encodeURIComponent(category)}`);
  }
  static {
    this.\u0275fac = function LabExamService_Factory(t) {
      return new (t || _LabExamService)(\u0275\u0275inject(HttpClient));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _LabExamService, factory: _LabExamService.\u0275fac, providedIn: "root" });
  }
};
...
//# sourceMappingURL=chunk-6SNY3ZGW.js.map
