...
function LoginComponent_mat_card_33_div_9_Template(rf, ctx) {
  if (rf & 1) {
...
function LoginComponent_mat_card_33_mat_spinner_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 24);
  }
}
function LoginComponent_mat_card_33_mat_icon_32_Template(rf, ctx) {
  if (rf & 1) {
...
function LoginComponent_mat_card_33_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-card", 10)(1, "mat-card-header")(2, "mat-icon", 11);
    \u0275\u0275text(3, "lock");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(7, "Ingresa tus credenciales de acceso");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "mat-card-content");
    \u0275\u0275template(9, LoginComponent_mat_card_33_div_9_Template, 4, 1, "div", 12);
    \u0275\u0275elementStart(10, "form", 13);
    \u0275\u0275listener("ngSubmit", function LoginComponent_mat_card_33_Template_form_ngSubmit_10_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(18, "Usuario requerido");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "mat-form-field", 14)(20, "mat-label");
    ...
    \u0275\u0275listener("click", function LoginComponent_mat_card_33_Template_button_click_25_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(29, "Contrase\xF1a requerida");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(30, "button", 19);
    \u0275\u0275template(31, LoginComponent_mat_card_33_mat_spinner_31_Template, 1, 0, "mat-spinner", 20)(32, LoginComponent_mat_card_33_mat_icon_32_Template, 2, 0, "mat-icon", 21);
    \u0275\u0275text(33);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(34, "mat-card-actions")(35, "a", 22)(36, "mat-icon");
    \u0275\u0275text(37, "arrow_back");
    \u0275\u0275elementEnd();
    \u0275\u0275text(38, " Volver al Portal ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.hidePassword ? "visibility" : "visibility_off");
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", ctx_r1.loginForm.invalid || ctx_r1.loading);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.loading);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.loading);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.loading ? "Ingresando..." : "Ingresar", " ");
  }
}
function LoginComponent_mat_card_34_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23)(1, "mat-icon");
    \u0275\u0275text(2, "error_outline");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", ctx_r1.changeError, " ");
  }
}
function LoginComponent_mat_card_34_mat_spinner_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 24);
  }
}
function LoginComponent_mat_card_34_mat_icon_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "save");
    \u0275\u0275elementEnd();
...
function LoginComponent_mat_card_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-card", 10)(1, "mat-card-header")(2, "mat-icon", 25);
    \u0275\u0275text(3, "password");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-card-title");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "mat-card-subtitle");
    \u0275\u0275text(7, "Su contrase\xF1a temporal ha expirado. Debe establecer una nueva.");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "mat-card-content")(9, "div", 26)(10, "mat-icon");
    \u0275\u0275text(11, "info");
    \u0275\u0275elementEnd();
    \u0275\u0275text(12, " La contrase\xF1a debe tener m\xEDnimo 8 caracteres, al menos una may\xFAscula y un n\xFAmero. ");
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, LoginComponent_mat_card_34_div_13_Template, 4, 1, "div", 12);
    \u0275\u0275elementStart(14, "form", 13);
    \u0275\u0275listener("ngSubmit", function LoginComponent_mat_card_34_Template_form_ngSubmit_14_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.submitPasswordChange());
    });
    \u0275\u0275elementStart(15, "mat-form-field", 14)(16, "mat-label");
    \u0275\u0275text(17, "Contrase\xF1a actual (temporal)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "mat-icon", 15);
    \u0275\u0275text(19, "lock_open");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function LoginComponent_mat_card_34_Template_button_click_29_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(33, "M\xEDn. 8 caracteres, 1 may\xFAscula, 1 n\xFAmero");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "mat-error");
    \u0275\u0275text(35, "Contrase\xF1a inv\xE1lida (m\xEDn. 8 chars, 1 may\xFAscula, 1 n\xFAmero)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "button", 19);
    \u0275\u0275template(37, LoginComponent_mat_card_34_mat_spinner_37_Template, 1, 0, "mat-spinner", 20)(38, LoginComponent_mat_card_34_mat_icon_38_Template, 2, 0, "mat-icon", 21);
    \u0275\u0275text(39);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(13);
    \u0275\u0275property("ngIf", ctx_r1.changeError);
    \u0275\u0275advance();
    \u0275\u0275property("formGroup", ctx_r1.changeForm);
    \u0275\u0275advance(14);
    \u0275\u0275property("type", ctx_r1.hideNew ? "password" : "text");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.hideNew ? "visibility" : "visibility_off");
    \u0275\u0275advance(5);
    \u0275\u0275property("disabled", ctx_r1.changeForm.invalid || ctx_r1.changingPassword);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.changingPassword);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.changingPassword);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.changingPassword ? "Guardando..." : "Guardar Nueva Contrase\xF1a", " ");
  }
}
var LoginComponent = class _LoginComponent {
    ...
    this.authService.login(this.loginForm.value).subscribe({
      next: (res) => {
        if (res.success) {
          ...
          this.errorMessage = "Usuario o contrase\xF1a inv\xE1lidos.";
        }
        this.loading = false;
      },
      error: () => {
    ...
    this.authService.changePassword(currentPassword, newPassword).subscribe({
      next: (res) => {
        if (res.success) {
          ...
          if (user) {
            const updated = __spreadProps(__spreadValues({}, user), { mustChangePassword: false });
            this.authService.updateCurrentUser(updated);
          }
          this.showChangePassword = false;
          this.redirectByRole();
        } else {
          this.changeError = res.message || "Error al cambiar contrase\xF1a.";
        }
        this.changingPassword = false;
      },
      error: (err) => {
        this.changeError = err.error?.message || "Error al cambiar contrase\xF1a.";
        this.changingPassword = false;
      }
    });
  }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 35, vars: 2, consts: [[1, "login-page"], [1, "login-left"], [1, "login-brand"], [1, "brand-icon"], [1, "login-features"], [1, "feature"], [1, "patient-link"], ["mat-stroked-button", "", "routerLink", "/register", 1, "register-btn"], [1, "login-right"], ["class", "login-card", 4, "ngIf"], [1, "login-card"], ["mat-card-avatar", ""], ["class", "error-alert", 4, "ngIf"], [3, "ngSubmit", "formGroup"], ["appearance", "outline", 1, "full-width"], ["matPrefix", ""], ["matInput", "", "formControlName", "username", "placeholder", "Nombre de usuario", "autocomplete", "username"], ["matInput", "", "formControlName", "password", "autocomplete", "current-password", 3, "type"], ["mat-icon-button", "", "matSuffix", "", "type", "button", 3, "click"], ["mat-raised-button", "", "color", "primary", "type", "submit", 1, "full-width", "submit-btn", 3, "disabled"], ["diameter", "20", 4, "ngIf"], [4, "ngIf"], ["mat-button", "", "routerLink", "/portal"], [1, "error-alert"], ["diameter", "20"], ["mat-card-avatar", "", 2, "color", "#e65100"], [1, "info-alert"], ["matInput", "", "type", "password", "formControlName", "currentPassword"], ["matInput", "", "formControlName", "newPassword", 3, "type"]], template: function LoginComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(14, "Acceso seguro y protegido");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(25, "div", 6)(26, "p");
        \u0275\u0275text(27, "\xBFEs paciente nuevo?");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(28, "a", 7)(29, "mat-icon");
        \u0275\u0275text(30, "person_add");
        \u0275\u0275elementEnd();
        \u0275\u0275text(31, " Registrarse en l\xEDnea ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(32, "div", 8);
        \u0275\u0275template(33, LoginComponent_mat_card_33_Template, 39, 8, "mat-card", 9)(34, LoginComponent_mat_card_34_Template, 40, 8, "mat-card", 9);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(33);
        \u0275\u0275property("ngIf", !ctx.showChangePassword);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.showChangePassword);
      }
    }, dependencies: [
